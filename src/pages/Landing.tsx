...
import { Leaf, Recycle, Award, Users, ArrowRight, MapPin, TrendingUp } from 'lucide-react';
        ...
        <div className="container px-4">
          <div className="mx-auto max-w-3xl text-center">
            <div className="inline-flex items-center gap-2 rounded-full bg-primary/10 px-4 py-2 mb-6">
              ...
              <span className="text-sm font-medium text-primary">A Sustainable Initiative by Enactus NSUT</span>
            </div>
            ...
            <p className="text-xl text-muted-foreground mb-8">
              Electronic Collection & Handling Organization - Transform your e-waste into eco-points. 
              Join the sustainable revolution at NSUT.
            </p>
        ...
        <div className="container px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <div className="text-sm text-muted-foreground">Collection Bins</div>
            </div>
            <div className="text-center">
            ...
            <div className="text-center">
              <div className="text-3xl md:text-4xl font-bold text-primary mb-2">100kg+</div>
              <div className="text-sm text-muted-foreground">E-waste Collected</div>
            </div>
            <div className="text-center">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            <Card className="border-2 hover:border-primary/50 transition-colors">
              <CardContent className="pt-6">
                ...
                <p className="text-muted-foreground">
                  Drop your electronic waste at any of our 6 strategically placed bins across campus.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-2 hover:border-primary/50 transition-colors">
              <CardContent className="pt-6">
                ...
                <p className="text-muted-foreground">
                  Log your submission and earn eco-points based on the type and quantity of e-waste.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-2 hover:border-primary/50 transition-colors">
              <CardContent className="pt-6">
                ...
                <p className="text-muted-foreground">
                  Exchange your points for exclusive coupons and rewards from our partner brands.
                </p>
              </CardContent>
            </Card>
          </div>
